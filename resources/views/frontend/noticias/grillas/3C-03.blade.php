<section id="contenedor-grilla">
    ...
    <div class="row">
        @if(isset($e[2]))
        <div class="col s12 m12 l12 @if($e[2]['type'] == 3) row-3C-publicidad @else row-3C @endif">
            @component('frontend.noticias.elementos.3c', ['type' => $e[2]['type'], 'e' => $e[2]['content']])@endcomponent
        </div>
        @endif
    </div>
</section>